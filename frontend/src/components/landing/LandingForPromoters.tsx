      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <Link to="/register">
              <Button size="lg" variant="secondary" className="h-11 px-6 border-gray-300">
                Join as a promoter
...
function PromoterMockup() {
  return (
    <div className="relative">
      <div className="absolute -inset-4 bg-gradient-to-tr from-brand-teal/5 to-brand-purple/5 rounded-3xl blur-2xl opacity-60" />
      <div className="relative bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
        ...
        <div className="p-5 bg-gray-50/50">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-12 h-12 rounded-full bg-brand-teal-50 text-brand-teal-900 flex items-center justify-center text-sm font-medium border border-brand-teal-200">
              SP
            </div>
            <div>
              <p className="text-sm font-medium text-gray-900">Sushma Pandey</p>
            ...
            <div className="space-y-2">
              {[
                ...
                <div key={s.label} className="flex items-center gap-3">
                  ...
                  <span className="text-[10px] font-medium text-brand-teal w-8 text-right">{s.value}%</span>
                </div>
              ))}
            </div>
          </div>
          <div className="bg-white border border-gray-200 rounded-xl p-4">
            ...
            <p className="text-xs text-gray-900 font-medium">Summer Launch · Himalayan Brew Co.</p>
