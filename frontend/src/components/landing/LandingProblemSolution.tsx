            ...
            <div className="flex flex-col gap-4">
              {problems.map((p) => (
                <motion.div key={p.title} variants={item} className="flex gap-4 bg-white border border-gray-200 rounded-xl p-5">
                  <span className="w-8 h-8 rounded-lg bg-brand-coral-50 border border-red-200 flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex flex-col gap-4">
              {solutions.map((s) => (
                <motion.div key={s.title} variants={item} className="flex gap-4 bg-white border border-gray-200 rounded-xl p-5">
                  <span className="w-8 h-8 rounded-lg bg-brand-teal-50 border border-brand-teal-200 flex items-center justify-center flex-shrink-0">
