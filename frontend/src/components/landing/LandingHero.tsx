...
export default function LandingHero() {
  return (
    <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
      <div className="absolute inset-0 -z-10 bg-gradient-to-b from-brand-purple-50/40 via-white to-white" />
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-medium text-gray-900 tracking-tight leading-[1.1] mb-6">
              Connect with the{" "}
...
function DashboardMockup() {
  return (
    <div className="relative">
      <div className="absolute -inset-4 bg-gradient-to-r from-brand-purple/10 to-brand-indigo/10 rounded-3xl blur-2xl opacity-60" />
      <div className="relative bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
        ...
        <div className="flex items-center gap-1.5 px-4 py-3 border-b border-gray-100 bg-gray-50/50">
          ...
          <div className="flex-1 mx-4">
            <div className="max-w-md mx-auto h-6 bg-white border border-gray-200 rounded-md flex items-center px-3">
        ...
        <div className="p-5 bg-gray-50/50">
          <div className="flex items-center justify-between mb-5">
            <div>
              ...
              <p className="text-sm font-medium text-gray-900">Summer Launch 2026</p>
            </div>
            <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium bg-brand-teal-50 text-brand-teal border border-teal-200">
              Active
            </span>
          </div>
...
function ScoreBadge({ score }: { score: number }) {
  const color =
    score >= 85
      ? "bg-brand-teal-50 text-brand-teal-900 border-brand-teal-200"
      : score >= 70
        ? "bg-brand-amber-50 text-brand-amber-900 border-brand-amber-200"
