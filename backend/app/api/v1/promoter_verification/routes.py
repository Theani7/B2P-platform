"""Promoter verification request routes."""
...
router = APIRouter(prefix="/promoter/verification-request", tags=["promoter-verification"], dependencies=[Depends(require_role(Role.PROMOTER))])
